...
<header className="header" id="inicio"><div className="container nav"><Brand/><nav aria-label="Menu principal"><a href="#colecao">A coleção</a><a href="#como-funciona">Como funciona</a><a href="#duvidas">Dúvidas</a></nav><a className="nav-cta" href={CHECKOUT_URL}>Quero meus moldes<ArrowRight size={17}/></a></div></header>
...
<section className="closing"><div className="container"><PawPrint className="closing-paw" size={32} strokeWidth={1.3}/><h2>Sua próxima fonte de renda<br/>pode começar com <em>um molde.</em></h2><Cta>Quero começar por R$ 9,90</Cta></div></section>
